...
- make sure publication updates work properly as it seems to not be getting everything
- do not commit to public in the git repo
- maybe switch from cron job to ssh key
- form for submitting news articles?
